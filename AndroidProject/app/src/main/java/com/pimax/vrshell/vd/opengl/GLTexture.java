...
//这是一张可以提供背景图的静态Texture
public class GLTexture {
    public static GLTexture uniqueInstance;
    public static GLTexture getInstance() {
        if (uniqueInstance == null) {
            uniqueInstance = new GLTexture();
        }
    ...
    public void setupOpenGL() {
        ...
        mRenderThread.execute(new Runnable() {
            ...
            public void run() {
                ...
                mTextureWidth = 2491;//670;
                mTextureHeight = 783;//670;
            }
        });
    }
    ...
    public void updateTextureBitmap(final Bitmap bitmap) {
