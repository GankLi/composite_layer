...
public class GLES30 extends GLES20{
  ...
  public static void glGenVertexArrays(int n,
                                       int[] arrays,
                                       int offset) {
    if(GLES20.LOGGABLED1) glGetError();
    if(GLES20.LOGGABLED2) Log.d(TAG, "glGenVertexArrays paras:"+n + " paras:"+toString(arrays)+" paras:"+offset);
  ...
  public static void glBindVertexArray(int array){
    if(GLES20.LOGGABLED1) glGetError();
    if(GLES20.LOGGABLED2) Log.d(TAG, "glBindVertexArray paras:"+array);
  ...
  public static void glTransformFeedbackVaryings(
    ...
    if(GLES20.LOGGABLED1) glGetError();
    if(GLES20.LOGGABLED2) Log.d(TAG, "glTransformFeedbackVaryings paras:"+program+" paras:"+varyings.toString()+" paras:"+bufferMode);
  ...
  public static void glDispatchCompute(
    ...
    if(GLES20.LOGGABLED1) glGetError();
    if(GLES20.LOGGABLED2) Log.d(TAG, "glDispatchCompute paras:"+num_groups_x+" paras:"+num_groups_y+" paras:"+num_groups_z);
  ...
  public static void glMemoryBarrier(
    ...
    if(GLES20.LOGGABLED1) glGetError();
    if(GLES20.LOGGABLED2) Log.d(TAG, "glMemoryBarrier paras:"+barriers);
  ...
  public static void glBeginTransformFeedback(
    ...
    if(GLES20.LOGGABLED1) glGetError();
    if(GLES20.LOGGABLED2) Log.d(TAG, "glBeginTransformFeedback paras:"+primitiveMode);
  ...
  public static void glEndTransformFeedback(
    ...
    if(GLES20.LOGGABLED1) glGetError();
    if(GLES20.LOGGABLED2) Log.d(TAG, "glEndTransformFeedback paras:");
  ...
  public static void glBindBufferRange(
    ...
    if(GLES20.LOGGABLED1) glGetError();
    if(GLES20.LOGGABLED2) Log.d(TAG, "glBindBufferRange paras:"+target+" paras:"+index+" paras:"+buffer+" paras:"+offset+" paras:"+size);
  ...
  public static void glBindBufferBase(
    ...
    if(GLES20.LOGGABLED1) glGetError();
    if(GLES20.LOGGABLED2) Log.d(TAG, "glBindBufferBase paras:"+target+" paras:"+index+" paras:"+buffer);
  ...
  public static void glBindTransformFeedback(
    ...
    if(GLES20.LOGGABLED1) glGetError();
    if(GLES20.LOGGABLED2) Log.d(TAG, "glBindTransformFeedback paras:"+target+" paras:"+id);
  ...
  public static void glGenTransformFeedbacks(
    ...
    if(GLES20.LOGGABLED1) glGetError();
    if(GLES20.LOGGABLED2) Log.d(TAG, "glGenTransformFeedbacks paras:"+n+" paras:"+toString(ids)+" paras:"+offset);
  ...
  public static java.nio.Buffer glMapBufferRange(
    ...
    if(GLES20.LOGGABLED1) glGetError();
    if(GLES20.LOGGABLED2) Log.d(TAG, "glMapBufferRange paras:"+target+" paras:"+offset+" paras:"+length+" paras:"+access);
  ...
  public static boolean glUnmapBuffer(
    ...
    if(GLES20.LOGGABLED1) glGetError();
    if(GLES20.LOGGABLED2) Log.d(TAG, "glUnmapBuffer paras:"+target);
  ...
  public static void glFlushMappedBufferRange(
    ...
    if(GLES20.LOGGABLED1) glGetError();
    if(GLES20.LOGGABLED2) Log.d(TAG, "glFlushMappedBufferRange paras:"+target+" paras:"+offset+" paras:"+length);
