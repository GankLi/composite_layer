...
public abstract class SvrPlugin
{
    ...
    public virtual IEnumerator EndVr()
    {
        eyes = null;
        overlays = null;
    ...
    //---------------------------------------------------------------------------------------------
    public virtual void ControllerGetPredictedPose(int handle, ref SvrControllerPredictedPose state) {
    }
    ...
    public virtual void RequestBoundaryVisible(bool visible) { }
